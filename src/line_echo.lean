...
meta def main_loop_internal (sock : socket) : string → io unit :=
-- FIXME why does this lambda have to be in here!?!
    λ buff, do
    newchunk ← read_sock_chunk sock,
    new_buff ← parse_chunk (string.append buff newchunk),
    main_loop_internal new_buff
